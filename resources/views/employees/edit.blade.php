...
<div class="container">
	    	...
	    	<div class="col-md-8 mt-4">
	    		<div class="row">
	    			...
	    			<div class="col-md-6 d-flex justify-content-end">
	    				<a href="{{ route('Job.create', $employee->slug) }}" class="btn btn-primary"><i class="fas fa-hard-hat"></i> Nuevo Puesto</a>
	    			</div>
	    		</div>
	    	</div>
	    </div>
		        ...
		        <div class="col-md-8">
		            <div class="card">
		                ...
		                <div class="card-body">
							...
							<form action="{{ route('Job.destroy', $employee->id) }}" method="POST" class="form-inline-block mt-2">
					    		@csrf
					    		@method('delete')
					    		<button onclick="deleteJob(event)" type="submit" class="btn btn-danger"><i class="fas fa-trash-alt"></i> Eliminar</button>
					    	</form>
		                </div>
		            </div>
		        </div>
	...
	<div class="row justify-content-center">
    	<div class="col-md-8 mt-4">
    		<div class="row">
    			<div class="col-md-6 d-flex align-items-center">
    				<h3 class="mb-0">No hay puestos registrados</h3>
    			</div>
    			<div class="col-md-6 d-flex justify-content-end">
    				<a href="{{ route('Job.create', $employee->slug) }}" class="btn btn-primary"><i class="fas fa-hard-hat"></i> Nuevo Puesto</a>
    			</div>
